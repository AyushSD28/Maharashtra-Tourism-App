...
class DagdusethTemple extends StatefulWidget {
  const DagdusethTemple({super.key});

  @override
  State<DagdusethTemple> createState() => _DagdusethTempleState();
}

class _DagdusethTempleState extends State<DagdusethTemple> {
        ...
        title: Row(
          children: [
            ...
            IconButton(
                ...
                icon: Icon(
                  iconColor ? Icons.favorite : Icons.favorite_outline,
                  color: iconColor
                      ? Colors.red
                      : const Color.fromARGB(255, 122, 113, 113),
                ))
          ],
        ),
