...
class SwaminarayanTemple extends StatefulWidget {
  const SwaminarayanTemple({super.key});

  @override
  State<SwaminarayanTemple> createState() => _SwaminarayanTempleState();
}

class _SwaminarayanTempleState extends State<SwaminarayanTemple> {
